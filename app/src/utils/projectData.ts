...
export const getBuiltInProjects = (): Project[] => [
  ...
  },
  {
    ...
    gallery: [
      '/projects/animall-video.mp4',
      '/projects/animall-idle.gif',
      '/projects/animall-tail-wag.gif',
      '/projects/animall-pickup.gif',
      '/projects/animall-cart.gif',
      '/projects/animall-throw.gif',
      '/projects/animall-superman.gif',
      '/projects/animall-use.gif',
      '/projects/animall-game.png',
    ],
  },
  {
    id: 'project-roblox',
